...
`holding_parser._strip_comments` / `_extract_text`.
"""
...
##### market is listing venue (US / HK / A-Share / Other). Cash and
##### wealth-management products with no ticker are Other — not inferred from the bank.
...
##### market 是上市地（US / HK / A-Share / Other）。无代码的现金和理财为 Other，
##### 不根据银行券商推断为 A 股。
##### 以 ##### 开头的行是注释，解析时会被忽略。
"""
...
##### SPDR S&P 500 ETF SPY USD 20 450 IBKR
##### Tencent 0700.HK HKD 380 371.47 Futu
##### Kweichow Moutai 600519.SS CNY 10 1680 China Securities
##### E Fund Blue Chip 110011 CNY 40000 3.99 Alipay
##### USD Cash 50000 USD Schwab
##### Bank wealth-management product 100000 CNY CMB
##### Pershing Square PSH.L GBP 50 55 IBKR
"""
...
##### Apple AAPL USD 100 228 IBKR
##### SPDR S&P 500 ETF SPY USD 20 450 IBKR
##### 腾讯 0700.HK HKD 380 371.47 富途
##### 贵州茅台 600519.SS CNY 10 1680 中信证券
##### 易方达蓝筹精选 110011 CNY 40000 3.99 支付宝
##### 美元现金 50000 USD Schwab
##### 银行理财产品 100000 CNY 招商银行
##### Pershing Square PSH.L GBP 50 55 IBKR
"""
