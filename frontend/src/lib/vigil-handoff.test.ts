...
describe("isAllowedOrigin", () => {
  ...
  it.each([
    "https://evil.example",
    "https://vigil.portfonia.com.evil.example",
    "https://sub.vigil.portfonia.com",
    "http://vigil.portfonia.com",
    "https://vigil.portfonia.com/",
    "https://Vigil.portfonia.com",
    "*",
    "",
  ...
  it("never treats a wildcard config as allowed", () => {
    expect(isAllowedOrigin("https://vigil.portfonia.com", "*")).toBe(false);
  });
});
