// Vendored from npm package `altcha@2.3.0` (frontend/node_modules/altcha/dist/altcha.js),
// self-hosted here so /forgot-password never loads widget JS from an external CDN
// (issue #231). Speaks the classic v1 challenge protocol (challengeurl/maxnumber
// attributes) matching the backend's altcha (Python) v1 API in
// backend/app/services/altcha_challenge.py. To update: `bun add altcha@2` in
// frontend/, then re-copy node_modules/altcha/dist/altcha.js over this file --
// do NOT bump past major version 2 without re-verifying the protocol match
// (altcha@3 switched to a KDF-based "next-gen PoW" protocol the backend does not speak).
