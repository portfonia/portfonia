...
- [Portfolio Performance — Phase 1 + tracking-start + holiday history + param-limit fixes](docs/mechanisms/portfolio-performance.md) — issue #360/#382/#383/#366/#377/#398/#402/#403/#406/#407/#433/#486/#487: snapshot tables, approximate EOD TWR, `tracking_start` correction (#366), benchmark/FX multi-year seed scripts, both scripts' 65535-param chunking fix, #406 USDCNH history (Twelve Data, closed), #407 csi300 Tencent kline fallback when yfinance drops dates, #433 asset-class allocation history + monthly performance (single-benchmark) + CSI300 Performance-page color fix, #486 frontend dashed connector across missing snapshot dates (per-gap columns + null calendar-row insertion), #487 every-day capture + `approx_carried` disclosure + fingerprint-gated weekend backfill script.
